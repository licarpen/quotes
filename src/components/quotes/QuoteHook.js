...
const Quote = () => {
  ...
  const characters = ['Bender', 'Fry', 'Leela', 'Professor Farnsworth', 'Amy', 'Zapp Brannigan', 'Lurr', 'Dr Zoidberg', 'Linda the reporter', 'Bob Barker', 'Hermes', 'Morgan Proctor', 'Mom', 'Robot Mob', 'Giant', 'Kif', 'Don bot'];
  ...
  return (
    ...
    <div className={styles.Quote}>
      ...
      <input onChange={({ target }) => handleNumQuotesChange(parseInt(target.value))} type='range' min='2' max='100' value={numQuotes}  id='numQuotes'></input>
